  ...
  render() {
    ...
    return (
      <div>
        ...
        <DateTitle className='month-name' content={moment().format('MMMM')}/>
        ...
        <section className='daily-section'>
          <DateTitle className='day-name' content={moment().format('dddd Do')}/>
          <ExpenseInput category='category'
                        categoryCost='cost'
                        buttonText='Submit'
                        timeFrame='daily'
        ...
        <SpendingHabits className='date-picker' dailyExpensesList={ dailyExpenses } />
